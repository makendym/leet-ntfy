...
export function GroupNudgingCard() {
    return (
        <section className="bg-gradient-to-br from-[#ffa116]/5 to-transparent border border-[#ffa116]/10 rounded-2xl p-4 flex items-center justify-between group hover:border-[#ffa116]/30 transition-all">
